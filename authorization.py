...
def get_access_token(request_token, request_secret, verifier):
	"""
	Get a token which will allow us to make request to the API
	"""
	oauth = OAuth1(CLIENT_KEY, client_secret=CLIENT_SECRET, resource_owner_key=request_token,
...
def authorize():
	...
	oauth = OAuth1(CLIENT_KEY, client_secret=CLIENT_SECRET, resource_owner_key=access_token,
